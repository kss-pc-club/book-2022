...
ここで一つ、試験を受けたいなと思ったときは、なるべく早めに申し込むようにしましょう。CBT のテストでは、専用の機械がおいてある必要があるので場所が限られています。そのため、会場に申し込もうとしても空席が無かったり、あったとしても遠すぎる場所になってしまいます。（ちなみに自分はFEのために福島にいきました。）
...
しかし、午後試験では記述式の設問が加わり、FE ではなかった論理的思考力や知識の応用力などが問われます。
...
しかしながら、ストラテジ系は時間が足らずあまり勉強ができませんでした。また、単純に苦手だったのでここの得点率がそこまで伸びませんでした。（得意の分野であるテクノロジ系が出題割合が大きかったので助かりました...）
...
また、記述形式の設問については基本的に使うべきキーワードを正しく使って解答できているかという点が重要です。そのため、過去問の解答を見ても、例えば字数制限 40 字に対して解答が 20 字などということがあります。国語の試験でよくある「字数制限ギリギリまで書く」などといったことはありません。
